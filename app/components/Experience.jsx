...
export default function Experience() {
    ...
    return (
        <section className="max-w-[1320px] mx-auto px-4 py-10">
            ...
            <div className="flex items-center gap-x-20 flex-col xl:flex-row 2xl:gap-32 mb-10">

                <h2 className="font-bold lg:text-5xl sm:text-3xl text-2xl text-center xl:text-left w-auto sm:w-xs lg:w-xl xl:w-auto leading-8 sm:leading-14 mb-3 xl:mb-0">Experience that grows with your scale.</h2>

                <p className="text-gray-500 text-sm md:text-lg text-center xl:text-left">Design a financial operating system that works for your business and streamlined cash flow management</p>
            </div>
